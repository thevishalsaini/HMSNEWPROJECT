    ...
    if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date) {
      $check_query = mysqli_query($con,"select apptime from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
        ...
        if(mysqli_num_rows($check_query)==0){
          $query=mysqli_query($con,"insert into appointmenttb(pname,fhname,address,age,gender,dob,contact,dept,doctor,docFees,appdate,apptime,room,userStatus,doctorStatus) values('$pname','$fhname','$address','$age','$gender','$dob','$contact','$dept','$doctor','$docFees','$appdate','$apptime','$room','1','1')");
...
if(isset($_GET['cancel']))
  {
    $query=mysqli_query($con,"update appointmenttb set userStatus='0' where copd = '".$_GET['copd']."'");
    if($query)
    {
...
function generate_bill(){
  ...
  $query=mysqli_query($con,"select p.copd,p.name,p.doctor,p.appdate,p.apptime,p.disease,p.allergy,p.prescription,a.docFees from prestb p inner join appointmenttb a on p.copd = '$pcopd");
  while($row = mysqli_fetch_array($query)){
    $output .= '
    <label> Patient COPD : </label>'.$row["copd"].'<br/><br/>
    <label> Patient Name : </label>'.$row["pname"].'<br/><br/>
...
function get_depts(){
  $con=mysqli_connect("localhost","root","","myhmsdb1");
  $query=mysqli_query($con,"select username,dept from doctb");
  $docarray = array();
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Kunwar Shekhar Vijendra Ayurved Medical College & Research Center </a>
            ...
            <div class="card-body">
              ...
              <form class="form-group" method="post" action="admin-panel.php">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <input type="text" class="form-control" name="pname" onkeydown="return alphaOnly(event);" required>
                  </div>
                  <br><br>
                  ...
                  <div class="col-md-8">
                    <input type="text" class="form-control" name="fhname" onkeydown="return alphaOnly(event);" required>
                  </div>
                  <br><br>
                  ...
                  <div class="col-md-8">
                    <input type="text" class="form-control" name="address" onkeydown="return alphaOnly(event);" required>
                  </div>
                  <br><br>
                  ...
                  <div class="col-md-8">
                    <input type="text" class="form-control" name="age" onkeydown="return alphaOnly(event);" required>
                  </div>
                  <br><br>
                  ...
                  <div class="col-md-8"><input type="date" class="form-control datepicker" name="dob"></div><br><br>

                  <div class="col-md-4">
                    <label>Contact Number:</label>
                  </div>
                  <div class="col-md-8">
                     <input type="tel" minlength="10" maxlength="10" class="form-control" name="contact" onkeydown="return alphaOnly(event);" required>
                  </div><br><br>
                    ...
                    <div class="col-md-4">
                        ...
                        <script>
                      document.getElementById('depts').onchange = function foo() {
                        let dept = this.value;   
                        console.log(dept)
                        ...
                        docs.forEach((el, ind, arr)=>{
                          ...
                          if (el.getAttribute("data-dept") != dept ) {
              ...
              document.getElementById('doctor').onchange = function updateFees(e) {
                ...
                document.getElementById('docFees').value = selection;
                  ...
                  <div class="col-md-4">
                    <label>Visit to Room No:</label>
                  </div>
                  <div class="col-md-8">
                     <input type="num" minlength="1" maxlength="3" class="form-control" name="room" onkeydown="return alphaOnly(event);" required>
                  </div><br><br>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select pname,copd,doctor,docFees,appdate,apptime,userStatus,doctorStatus from appointmenttb";
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                      echo "Cancelled by Doctor";
                        ...
                        { ?>
	                        ...
	                        <a href="admin-panel.php?copd=<?php echo $row['copd']?>&cancel=update" 
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select doctor,copd,appdate,apptime,disease,allergy,prescription from prestb";
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              ...
                              <a href="admin-panel.php?copd=<?php echo $row['copd']?>">
                              <input type ="hidden" name="copd" value="<?php echo $row['copd']?>"/>
