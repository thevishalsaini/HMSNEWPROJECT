...
if(isset($_POST['docsub']))
{
  ...
  $query="insert into doctb(username,password,email,dept,docFees)values('$doctor','$dpassword','$demail','$dept','$docFees')";
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    ...
    <div class="tab-pane fade" id="list-doc" role="tabpanel" aria-labelledby="list-home-list">
      <div class="col-md-12">
        <form class="form-group" action="doctorsearch.php" method="post">
          <div class="row">
            <div class="col-md-8"><input type="text" name="doctor_contact" placeholder="Enter Email ID" class = "form-control"></div>
            <div class="col-md-2"><input type="submit" name="doctor_search_submit" class="btn btn-primary" value="Search"></div>
            <div class="col-md-2"><a class="nav-link" onclick="downloadlist('doctor')"><i class="fa fa-download" aria-hidden="true"></i> Download</a></div>
          </div>
        </form>
      </div>
    ...
    <div class="tab-pane fade" id="list-pat" role="tabpanel" aria-labelledby="list-pat-list">
      <div class="col-md-12">
        <form class="form-group" action="patientsearch.php" method="post">
          <div class="row">
          <div class="col-md-8"><input type="text" name="patient_contact" placeholder="Enter Contact" class = "form-control"></div>
          <div class="col-md-2"><input type="submit" name="patient_search_submit" class="btn btn-primary" value="Search"></div>
          <div class="col-md-2"><a class="nav-link" onclick="downloadlist('patient')"><i class="fa fa-download" aria-hidden="true"></i> Download</a></div>
        </div>
    ...
    <div class="tab-pane fade" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
      ...
      <form class="form-group" action="appsearch.php" method="post">
        <div class="row">
        <div class="col-md-8"><input type="text" name="app_contact" placeholder="Enter Contact" class = "form-control"></div>
        <div class="col-md-2"><input type="submit" name="app_search_submit" class="btn btn-primary" value="Search"></div>
        <div class="col-md-2"><a class="nav-link" onclick="downloadlist('appointment')"><i class="fa fa-download" aria-hidden="true"></i> Download</a></div>
      </div>
      </form>
    </div>
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="deptmt" class="form-control" id="deptmt" required="required">
                      <option value="head" name="dept" disabled selected>Select Department</option>
                      <option value="Swasthaya Raksham" name="dept">Swasthaya Raksham</option>
                      <option value="Shalya" name="dept">Shalya</option>
                      <option value="Kaya" name="dept">Kaya</option>
                      <option value="Balroga" name="dept">Balroga</option>
                      <option value="Striroga" name="dept">Striroga</option>
                      <option value="Panchkarma" name="dept">Panchkarma</option>
                      <option value="Eye" name="dept">Eye</option>
                      <option value="Emergency" name="dept">Emergency</option>
                    </select>
                    </div><br><br>
   ...
   <script type="text/javaScript">
      function downloadlist(downloadtype){
        window.location.href = 'downloadpdf.php?generatepdf='+downloadtype;
        }
    </script>
  </body>
</html>