...
if(isset($_GET['cancel']))
  {
    $query=mysqli_query($con,"update appointmenttb set doctorStatus='0' where copd = '".$_GET['copd']."'");
    if($query)
    {
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select pname,copd,appdate,apptime,userStatus,doctorStatus from appointmenttb where doctor='$dname';";
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                     ...
                     <td>
                        ...
                        { ?>
	                        ...
	                        <a href="doctor-panel.php?copd=<?php echo $row['copd']?>&cancel=update"
                        ...
                        <a href="prescribe.php?copd=<?php echo $row['copd']?>&appdate=<?php echo $row['appdate']?>&apptime=<?php echo $row['apptime']?>&pname=<?php echo $row['pname']?>"
        ...
        <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select copd,pname,appdate,apptime,disease,allergy,prescription from prestb where doctor='$doctor';";
