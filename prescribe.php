...
if(isset($_POST['prescribe']))
{
  ...
  $query=mysqli_query($con,"insert into prestb(doctor,copd,pname,appdate,apptime,disease,allergy,prescription) values ('$doctor','$copd','$pname','$appdate','$apptime','$disease','$allergy','$prescription')");
    if($query)
    {
...
<body style="padding-top:50px;">
   ...
   <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
        <form class="form-group" name="prescribeform" method="post" action="prescribe.php?copd=<?php echo $_REQUEST["copd"];?>&appdate=<?php echo $_REQUEST["appdate"];?>&apptime=<?php echo $_REQUEST["apptime"];?>&pname=<?php echo $_REQUEST["pname"];?>">
          ...
          <div class="row">
                 ...
                 <!--  <input type="hidden" name="lname" value="<?php echo $lname ?>" /> -->
                  ...
                  <input type="hidden" name="copd" value="<?php echo $copd ?>" />
